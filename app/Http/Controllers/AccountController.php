...
class AccountController extends AppBaseController
{
    ...
    public function confirm_payment(Request $request) {
         /**
         * Receive account id
         * Check if logged in user is an admin or mederator
        ...
        $account = $this->accountRepository->findWithoutFail($request->input('confirm_payment'));
        ...
        AccountHistory::create([
            ...
            'account_id' => $account->id,
            'message' => 'Payout approved by admin:'.Auth::user()->id
        ]);

        Flash::success('Payout approved successfully');
        return redirect()->back();
    }
    /**
